          ...
          <div style={theme? {boxShadow: '#fff 0px 2px 8px 0px'}: {boxShadow: 'rgba(99, 99, 99, 0.2) 0px 2px 8px 0px'}} className='formDiv'>
            <div>
              ...
              <form  action="" ref={form} onSubmit={sendEmail} className='contactForm' style={theme?{backgroundColor: '#1e272e'}:{}}>
                ...
                <input data-aos="fade-left" data-aos-delay='1000' data-aos-duration='1000' style={theme?{backgroundColor: '#1e272e', color: '#fff', border: '1px solid #fff', borderRadius: '3px'}: {}}type="text" required name="from_name"/><br />
                <label data-aos="zoom-in" data-aos-delay='1100' data-aos-duration='1000' htmlFor="">Email<span className='redStar'>*</span></label><br />
                <input data-aos="fade-left" data-aos-delay='1100' data-aos-duration='1000' style={theme?{backgroundColor: '#1e272e', color: '#fff', border: '1px solid #fff', borderRadius: '3px'}: {}}type="email" required name="email_id"/><br />
                <label data-aos="zoom-in" data-aos-delay='1200' data-aos-duration='1000' htmlFor="">Mobile No.<span className='redStar'>*</span></label><br />
                <input data-aos="fade-left" data-aos-delay='1200' data-aos-duration='1000' style={theme?{backgroundColor: '#1e272e', color: '#fff', border: '1px solid #fff', borderRadius: '3px'}: {}}type="number" required name='mobile_no' minLength={10} maxLength={10}/><br />
                <label data-aos="zoom-in" data-aos-delay='1300' data-aos-duration='1000' htmlFor="">Message<span className='redStar'>*</span></label><br />
                <textarea data-aos="fade-left" data-aos-delay='1300' data-aos-duration='1000' style={theme?{backgroundColor: '#1e272e', color: '#fff', border: '1px solid #fff', borderRadius: '3px'}: {}} name="message" id="" cols="15" rows="10" required ></textarea><br />
                <button style={theme?{background: '#2c3a47'}:{background: '#6a6a6a'}} data-aos="fade-left" data-aos-delay='1400' data-aos-duration='1000' className="submit">Submit</button>
              </form>
            </div>
          </div>
        </div>
