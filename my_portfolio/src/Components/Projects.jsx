...
export const Projects = () => {
  ...
  return (
    <div id='projects' className='projects' style={theme?{backgroundColor: "#292929", color: "#fff"}: {backgroundColor: "#eee"}}>
      ...
      {/* <svg className='wave_2' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#0099ff" fill-opacity="1" d="M0,192L24,202.7C48,213,96,235,144,245.3C192,256,240,256,288,256C336,256,384,256,432,261.3C480,267,528,277,576,272C624,267,672,245,720,224C768,203,816,181,864,186.7C912,192,960,224,1008,240C1056,256,1104,256,1152,245.3C1200,235,1248,213,1296,202.7C1344,192,1392,192,1416,192L1440,192L1440,320L1416,320C1392,320,1344,320,1296,320C1248,320,1200,320,1152,320C1104,320,1056,320,1008,320C960,320,912,320,864,320C816,320,768,320,720,320C672,320,624,320,576,320C528,320,480,320,432,320C384,320,336,320,288,320C240,320,192,320,144,320C96,320,48,320,24,320L0,320Z"></path></svg> */}
